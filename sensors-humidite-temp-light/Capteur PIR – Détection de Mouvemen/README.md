...
2-Créer un channel pour le DHT11
    ...
    Nommer le channel, par exemple : ESP32 Motion Sensor
    Activer Field 1 pour le mouvement détecté
...
5-Connecter le PIR et la LED à l’ESP32
    VCC → 5V
    DATA → GPIO 5
    GND → GND
    LED → GPIO 2
...
8-Voir les données sur ThingSpeak
    ...
    La valeur de Field1 (Motion Sensor) est mises à jour en temps réel
